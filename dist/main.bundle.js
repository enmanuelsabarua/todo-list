...
function showTaskUI(instance, title) {    
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        if(items[i].dueDate) {
            result = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(items[i].dueDate), 'MM/dd/yyyy')
        }
